...
namespace WoWonder.Helpers.Utils
{
    public static class WoWonderTools
    {
        ...
        public static void SetAddFriend(Activity activity, UserDataObject item, Button btnAddUser , bool reels = false)
        {
            try
            {
        ...
        public static void SetAddFriendCondition(UserDataObject userData, string isFollowing, Button btnAddUser , bool reels = false)
        {
            try
            {
                                        ...
                                        if (!string.IsNullOrEmpty(item.LastMessage.LastMessageClass.Text))
                                        {
                                            ...
                                            else
                                            {
                                                if (item.LastMessage.LastMessageClass.Text.Contains("<i class="))
                                                    item.LastMessage.LastMessageClass.Text = PostFunctions.GetSmileTypeIcon(item.LastMessage.LastMessageClass.Text);
                ...
                switch (modelType)
                {
                    ...
                    case MessageModelType.RightText:
                        ...
                        if (item.Text.Contains("<i class="))
                            item.Text = PostFunctions.GetSmileTypeIcon(item.Text);

    ...
    public class CustomNavigationController : Java.Lang.Object , MeowBottomNavigation.IClickListener, MeowBottomNavigation.IReselectListener
    {
        ...
        private void Initialize()
        {
            try
            {
                ...
                Models.Add(new MeowBottomNavigation.Model(3, ContextCompat.GetDrawable(MainContext, Resource.Drawable.icon_more_vector)));
                ...
                NavigationTabBar.SetBackgroundBottomColor(WoWonderTools.IsTabDark() ? Color.Black : Color.White);
                NavigationTabBar.SetCircleColor(WoWonderTools.IsTabDark() ? Color.Black : Color.White);

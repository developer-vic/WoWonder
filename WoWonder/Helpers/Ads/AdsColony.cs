    ...
    public static class AdsColony
    {
        ...
        public static void InitBannerAd(Activity context, LinearLayout adContainer, AdColonyAdSize adSize, RecyclerView mRecycler)
        {
            try
            {
                ...
                if (WoWonderTools.GetStatusAds() && AppSettings.ShowColonyBannerAds)
                {
                    ...
                    AdColony.Configure(context, appOptions, AppSettings.AdsColonyAppId);
        ...
        private static void InitInterstitialAd(Activity context)
        {
            try
            {
                ...
                var listener = new MyAdColonyInterstitialListener(adOptions);

                AdColony.RequestInterstitial(AppSettings.AdsColonyInterstitialId, listener, adOptions);
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
        ...
        private class MyAdColonyInterstitialListener : AdColonyInterstitialListener
        {
            ...
            public MyAdColonyInterstitialListener(AdColonyAdOptions adOptions)
            {
                AdOptions = adOptions;
            }
            ...
            public override void OnExpiring(AdColonyInterstitial ad)
            {
                try
                {
                    ...
                    AdColony.RequestInterstitial(AppSettings.AdsColonyInterstitialId, this, AdOptions);

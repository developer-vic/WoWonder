...
namespace WoWonder.Helpers.Controller
{
    public class VideoController : Java.Lang.Object, View.IOnClickListener, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        public MoviesDataObject VideoData;
        ...
        public void PlayVideo(string videoUrL, MoviesDataObject videoObject)
        {
            try
            {
                if (videoObject != null)
        ...
        //Event Menu >> Share
        public async void OnMenu_ShareIcon_Click(MoviesDataObject video)
        {
            try
            {
        ...
        private void OnMenu_CopeLink_Click(MoviesDataObject video)
        {
            try
            { 

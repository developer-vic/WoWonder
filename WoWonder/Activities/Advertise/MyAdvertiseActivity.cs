...
namespace WoWonder.Activities.Advertise
{
    ...
    public class MyAdvertiseActivity : BaseActivity
    {
        ...
        private void InitToolbar()
        {
            try
            {
                ...
                if (toolBar != null)
                {
                    toolBar.Title = GetText(Resource.String.Lbl_Advertising);
        ...
        private void SetRecyclerViewAdapters()
        {
            try
            {
                CreateAds = FindViewById<TextView>(Resource.Id.toolbar_title);
                CreateAds.Visibility = ViewStates.Visible;
                CreateAds.Text = GetString(Resource.String.Lbl_Create);

                MainRecyclerView = FindViewById<WRecyclerView>(Resource.Id.Recyler);
                PostFeedAdapter = new NativePostAdapter(this, "", MainRecyclerView, NativeFeedType.Advertise);
            ...
            try
            {
                switch (addEvent)
                {
                    ...
                    case true:
                        ...
                        CreateAds.Click += CreateAdsOnClick;
                        break;
                    default:
                        SwipeRefreshLayout.Refresh -= SwipeRefreshLayoutOnRefresh;
                        CreateAds.Click -= CreateAdsOnClick;
        ...
        private void CreateAdsOnClick(object sender, EventArgs e)
        {
            try
            {

...
namespace WoWonder.Activities.Default
{
    ...
    public class RegisterActivity : BaseActivity, MaterialDialog.IListCallback
    {
        #region Variables Basic

        private RelativeLayout UsernameLayout, EmailLayout, BirthdayLayout, GenderLayout, PhoneNumLayout, PasswordLayout, ConfirmPasswordLayout;
        private EditText TxtUsername, TxtEmail, TxtBirthday, TxtGender, TxtPhoneNum, TxtPassword, TxtConfirmPassword;
        private TextView TxtUsernameRequired, TxtEmailRequired, TxtBirthdayRequired, TxtGenderRequired, TxtPhoneNumRequired, TxtPasswordRequired, TxtConfirmPasswordRequired;
        ...
        private void InitComponent()
        {
            try
            {
                ...
                BtnSignUp = FindViewById<AppCompatButton>(Resource.Id.btn_create_account);
        ...
        private async void BtnSignUpOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (apiStatus == 200 && respond is CreatAccountObject result)
                {
                    ...
                    if (AppSettings.ShowBirthdayInRegister)
                    {
                        var dataPrivacy = new Dictionary<string, string> { { "birthday", TxtBirthday.Text } };

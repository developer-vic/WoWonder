...
namespace WoWonder.Activities.Default
{
    ...
    public class SelectRegisterActivity : BaseActivity, IFacebookCallback, GraphRequest.IGraphJSONObjectCallback
    {
        #region Variables Basic
         
        private AppCompatButton BtnRegisterEmail, BtnGoogle, BtnFacebook; 
        ...
        private void InitComponent()
        {
            try
            {
                BtnRegisterEmail = FindViewById<AppCompatButton>(Resource.Id.btn_register_email);

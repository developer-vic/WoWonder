...
using WoWonder.Activities.Chat.Editor.Adapters;
using WoWonder.Helpers.Chat.Editor;
using WoWonder.Helpers.Utils;
using WoWonder.NiceArt.Models;
using DialogFragment = AndroidX.Fragment.App.DialogFragment;

namespace WoWonder.Activities.Chat.Editor.Tools
{
    public class TextEditorFragment : DialogFragment, ITextEditor
    {
        ...
        public TextEditorFragment Show(Activity contextActivity, ViewTextType type)
        {
            try
            {
                return Show(contextActivity, /*ImageActivity,*/ EditColorActivity, "", Resource.Color.gnt_white, type);
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);

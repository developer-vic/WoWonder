    ...
    public class MsgTabbedMainActivity : AppCompatActivity, TabLayoutMediator.ITabConfigurationStrategy, MaterialDialog.IListCallback
    {
        ...
        private void InitComponent()
        {
            try
            {
                ...
                Tabs.SetTabTextColors(WoWonderTools.IsTabDark() ? Color.White : Color.DimGray, Color.ParseColor(AppSettings.MainColor));
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
                    ...
                    else
                    {
                        switch (position)
                        {
                            ...
                            case 1:
                                ...
                                //if (AppSettings.EnableChatGroup)
                                //{
                                //    Task.Factory.StartNew(() => LastGroupChatsTab.StartApiService());
                                //}
                                //else if (AppSettings.EnableChatPage)
                                //{
                                //    Task.Factory.StartNew(() => LastPageChatsTab.StartApiService());
                                //}
                                //else
                                //{
                                //    Task.Factory.StartNew(() => LastStoriesTab.StartApiService());
                                //}
                                break;
                            // PageChats
                            case 2:

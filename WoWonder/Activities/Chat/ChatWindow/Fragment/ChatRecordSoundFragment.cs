            ...
            try
            {
                ...
                switch (Type)
                {
                    case "ChatWindowActivity":
                        ...
                        //MainActivity.ChatMediaButton.Enabled = false;
                        //MainActivity.EmojIconEditTextView.Enabled = false;
                        //MainActivity.ChatEmojImage.Enabled = false;
                    ...
                    case "StoryReplyActivity":
                        ...
                        MainStoryActivity.RecordButton.SetImageResource(Resource.Drawable.ic_send_vector);
                        MainStoryActivity.RecordButton.Tag = "Audio";
                        MainStoryActivity.RecordButton.SetListenForRecord(false);

                        //MainStoryActivity.ChatMediaButton.Enabled = false;
                        //MainStoryActivity.EmojIconEditTextView.Enabled = false;
                        //MainStoryActivity.ChatEmojImage.Enabled = false;
        ...
        private void SendRecordButtonOnClick(object sender, EventArgs e)
        {
            try
            {
                switch (Type)
                {
                    ...
                    case "StoryReplyActivity":
                        MainStoryActivity.RecordButton.Tag = "Audio";
                        MainStoryActivity.OnClick_OfSendButton();
                        break;
                }
            }
            ...
            try
            {
                ...
                switch (Type)
                {
                    case "ChatWindowActivity":
                        ...
                        MainActivity.ChatMediaButton.Enabled = true;
                        MainActivity.EmojIconEditTextView.Enabled = true;
                        MainActivity.ChatEmojImage.Enabled = true;
                        break;
                    case "StoryReplyActivity":
                        ...
                        MainStoryActivity.ChatMediaButton.Enabled = true;
                        MainStoryActivity.EmojIconEditTextView.Enabled = true;
                        MainStoryActivity.ChatEmojImage.Enabled = true;
                        break;
                }
            }
            catch (Exception exception)

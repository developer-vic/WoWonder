    ...
    public class TwilioAudioCallActivity : AppCompatActivity, ISensorEventListener, TwilioVideoHelper.IListener
    {
        ...
        private void InitComponent()
        {
            try
            {
                ...
                SpeakerAudioButton.SetImageResource(Resource.Drawable.ic_volume_off_grey_24dp);
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
        ...
        private void SpeakerAudioButtonOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    SpeakerAudioButton.SetImageResource(Resource.Drawable.ic_volume_up_grey_24dp);
                }

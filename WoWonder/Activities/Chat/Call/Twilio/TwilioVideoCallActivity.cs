    ...
    public class TwilioVideoCallActivity : AppCompatActivity, ISensorEventListener, TwilioVideoHelper.IListener
    {
        ...
        private void Mute_video_button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MuteVideoButton.SetImageResource(Resource.Drawable.icon_video_camera_mute_vector);

                    MuteVideoButton.Selected = false;
                }
                else
                {
                    MuteVideoButton.SetImageResource(Resource.Drawable.icon_video_camera);
                    MuteVideoButton.Selected = true;
                }
        ...
        private void Mute_audio_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (MuteAudioButton.Selected)
                {
                    ...
                    MuteAudioButton.SetImageResource(Resource.Drawable.icon_microphone_vector);
                }
                else
                {
                    MuteAudioButton.Selected = true;
                    MuteAudioButton.SetImageResource(Resource.Drawable.icon_microphone_mute_vector);
                }
        ...
        public override void OnPictureInPictureModeChanged(bool isInPictureInPictureMode, Configuration newConfig)
        {
            ...
            { 
                if (isInPictureInPictureMode)
                {
                    ...
                    SwitchCamButton.Visibility = ViewStates.Gone;
                ...
                else
                {
                    ...
                    SwitchCamButton.Visibility = ViewStates.Visible;

...
namespace WoWonder.Activities.Chat.SharedFiles.Adapter
{
    public class HSharedFilesAdapter : RecyclerView.Adapter, ListPreloader.IPreloadModelProvider
    {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            try
            {
                ...
                View itemView = LayoutInflater.From(parent.Context)?.Inflate(Resource.Layout.Style_HSharedFilesView, parent, false);

    ...
    public class DiscountTypeAdapterViewHolder : RecyclerView.ViewHolder
    {
        public DiscountTypeAdapterViewHolder(View itemView, Action<DiscountTypeAdapterClickEventArgs> clickListener, Action<DiscountTypeAdapterClickEventArgs> longClickListener) : base(itemView)
        {
            try
            {
                ...
                Methods.SetColorEditText(EdtDiscountFirst, WoWonderTools.IsTabDark() ? Color.White : Color.Black);
                Methods.SetColorEditText(EdtDiscountSec, WoWonderTools.IsTabDark() ? Color.White : Color.Black);
                Methods.SetColorEditText(EdtDiscountThr, WoWonderTools.IsTabDark() ? Color.White : Color.Black);

        ...
        private void MAdapterOnOnItemClick(object sender, MyVideoAdapterClickEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    ...
                    intent.PutExtra("VideosCount", MAdapter.MyVideoList.Count);
                    intent.PutExtra("DataItem", JsonConvert.SerializeObject(MAdapter.MyVideoList));
                    StartActivity(intent);
                }
            }
            catch (Exception exception)
            ...
            try
            {
                ...
                switch (MAdapter.MyVideoList.Count)
                {
                    ...
                    default:
                    {
                        ...
                        {
                            case false:
                                x.EmptyStateButton.Click += AddButtonOnClick;
                                    break;
                        }

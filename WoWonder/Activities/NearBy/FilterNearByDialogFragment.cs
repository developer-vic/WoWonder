        ...
        private void SetStatus()
        {
            switch (Status)
            {
                case 0:
                    ...
                    BothStatusButton.SetTextColor(WoWonderTools.IsTabDark() ? Color.ParseColor("#ffffff") : Color.ParseColor("#B0B6C3"));

                    ButtonOnline.SetBackgroundResource(Resource.Drawable.round_button_gray);
                    ButtonOnline.SetTextColor(WoWonderTools.IsTabDark() ? Color.ParseColor("#ffffff") : Color.ParseColor("#B0B6C3"));
                ...
                case 1:
                    ...
                    ButtonOffline.SetTextColor(WoWonderTools.IsTabDark() ? Color.ParseColor("#ffffff") : Color.ParseColor("#B0B6C3"));
        ...
        private void SetRelationship()
        {
            switch (RelationshipId)
            {
                case "1":
                    ...
                    BtnRelationship.SetTextColor(WoWonderTools.IsTabDark() ? Color.ParseColor("#ffffff") : Color.ParseColor("#B0B6C3"));

                    BtnMarried.SetBackgroundResource(Resource.Drawable.round_button_gray);
                    BtnMarried.SetTextColor(WoWonderTools.IsTabDark() ? Color.ParseColor("#ffffff") : Color.ParseColor("#B0B6C3"));

                    BtnEngaged.SetBackgroundResource(Resource.Drawable.round_button_gray);
                    BtnEngaged.SetTextColor(WoWonderTools.IsTabDark() ? Color.ParseColor("#ffffff") : Color.ParseColor("#B0B6C3"));

                    BtnRelationAll.SetBackgroundResource(Resource.Drawable.round_button_gray);
                    BtnRelationAll.SetTextColor(WoWonderTools.IsTabDark() ? Color.ParseColor("#ffffff") : Color.ParseColor("#B0B6C3"));
                ...
                case "2":
                    ...
                    BtnSingle.SetTextColor(WoWonderTools.IsTabDark() ? Color.ParseColor("#ffffff") : Color.ParseColor("#B0B6C3"));

                    ...
                    case 0:
                        {
                            ...
                            if (Methods.CheckConnectivity())
                                PollyController.RunRetryPolicyFunction(new List<Func<Task>> { () => LoadGeneralData(false) });
                            break;
                        }
                    //Last Activities
                    case 1:
                        ...
                        Activity?.RunOnUiThread(() =>
                        {
                            try
                            {
                                ...
                                if (respondList > 0)
                                {
                                    ...
                                    if (countList > 0)
                                    {
                                        MAdapter.NotifyItemRangeInserted(countList, MAdapter.NotificationsList.Count - countList);
                                    }
                                    else
                                    {
                                        MAdapter.NotifyDataSetChanged();
                                ...
                                if (respondListFriendRequests > 0)
                                {
                                    ...
                                    if (FriendRequestInflated == null)
                                    {
                                        ...
                                        if (user != null)
                                        {
                                            GlideImageLoader.LoadImage(Activity, user.Avatar, friendRequestImage, ImageStyle.CircleCrop, ImagePlaceholders.Drawable);
                            ...
                            try
                            {
                                ...
                                if (respondList > 0)
                                {
                                    if (CommunitiesRequestInflated == null)
                                    {
                                        ...
                                        if (user != null)
                                            GlideImageLoader.LoadImage(Activity, user.Avatar, CommunitiesImage, ImageStyle.CircleCrop, ImagePlaceholders.Drawable);

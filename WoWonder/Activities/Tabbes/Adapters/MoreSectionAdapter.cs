                ...
                switch (styleRowMore)
                {
                    ...
                    case StyleRowMore.Grid:
                        SectionList.Add(new SectionItem
                        {
                            ...
                            BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#282828") : Color.White,
                        ...
                        switch (AppSettings.MessengerIntegration)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#212121") : Color.ParseColor("#f8f8ff"),
                            ...
                            case true:
                                {
                                    ...
                                    SectionList.Add(new SectionItem
                                    {
                                        ...
                                        BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#262626") : Color.ParseColor("#fbf1ff"),
                        ...
                        switch (AppSettings.ShowPokes)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#282828") : Color.ParseColor("#f9fffa"),
                        ...
                        switch (AppSettings.ShowAlbum)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    StyleRow = styleRowMore,
                                    Badgevisibilty = false,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#212121") : Color.ParseColor("#f5fffd"),
                        ...
                        switch (AppSettings.ShowMyPhoto)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#262626") : Color.ParseColor("#fff9f9"),
                        ...
                        switch (AppSettings.ShowMyVideo)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#282828") : Color.ParseColor("#fff9f5"),
                        ...
                        switch (AppSettings.ShowSavedPost)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#212121") : Color.ParseColor("#fffef8"),
                        ...
                        switch (AppSettings.ShowCommunitiesGroups)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#262626") : Color.ParseColor("#fffef8"),
                                    Badgevisibilty = false,
                        ...
                        switch (AppSettings.ShowArticles)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    StyleRow = styleRowMore,
                                    Badgevisibilty = false,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#212121") : Color.ParseColor("#fff7f6"),
                        ...
                        switch (AppSettings.ShowMarket)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    StyleRow = styleRowMore,
                                    Badgevisibilty = false,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#262626") : Color.ParseColor("#f8f5ff"),
                        ...
                        if (AppSettings.ShowBoostedPosts || AppSettings.ShowBoostedPages)
                            SectionList.Add(new SectionItem
                            {
                                ...
                                StyleRow = styleRowMore,
                                Badgevisibilty = false,
                                BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#212121") : Color.ParseColor("#f2f3f7"),
                        ...
                        switch (AppSettings.ShowPopularPosts)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    StyleRow = styleRowMore,
                                    Badgevisibilty = false,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#282828") : Color.ParseColor("#fefaff"),
                        ...
                        switch (AppSettings.ShowEvents)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    BadgeCount = 0,
                                    StyleRow = styleRowMore,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#212121") : Color.ParseColor("#f6fff6"),
                                    Badgevisibilty = false,
                        ...
                        switch (AppSettings.ShowNearBy)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    StyleRow = styleRowMore,
                                    Badgevisibilty = false,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#262626") : Color.ParseColor("#f8fffe"),
                        ...
                        switch (AppSettings.ShowOffers)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    BadgeCount = 0,
                                    StyleRow = styleRowMore,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#282828") : Color.ParseColor("#fff8f8"),
                                    Badgevisibilty = false,
                        ...
                        switch (AppSettings.ShowMovies)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    BadgeCount = 0,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#212121") : Color.ParseColor("#fffbf8"),
                                    StyleRow = styleRowMore,
                                    Badgevisibilty = false,
                        ...
                        switch (AppSettings.ShowJobs)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    BadgeCount = 0,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#262626") : Color.ParseColor("#fffefa"),
                                    StyleRow = styleRowMore,
                                    Badgevisibilty = false,
                        ...
                        switch (AppSettings.ShowCommonThings)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    BadgeCount = 0,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#282828") : Color.ParseColor("#f8fcff"),
                                    StyleRow = styleRowMore,
                                    Badgevisibilty = false,
                        ...
                        switch (AppSettings.ShowMemories)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    BadgeCount = 0,
                                    StyleRow = styleRowMore,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#212121") : Color.ParseColor("#fff7fd"),
                                    Badgevisibilty = false,
                        ...
                        switch (AppSettings.ShowFundings)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    ...
                                    BadgeCount = 0,
                                    StyleRow = styleRowMore,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#262626") : Color.ParseColor("#fff4f2"),
                                    Badgevisibilty = false,
                        ...
                        switch (AppSettings.ShowGames)
                        {
                            case true:
                                ...
                                {
                                    Id = 23,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#282828") : Color.ParseColor("#faf7ff"),
                        ...
                        switch (AppSettings.ShowInfoCoronaVirus)
                        {
                            case true:
                                ...
                                {
                                    Id = 24,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#212121") : Color.ParseColor("#f8fcff"),
                                    SectionName = activityContext.GetText(Resource.String.Lbl_CoronaVirus),
                                    BadgeCount = 0,
                                    StyleRow = styleRowMore,
                                    Badgevisibilty = false,
                                    IconAsImage = Resource.Drawable.ic_more_virus,
                                    Icon = IonIconsFonts.Bug,
                                    IconColor = Color.ParseColor("#ff5991")
                                });
                                break;
                        }

                        switch (AppSettings.ShowLive)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    Id = 25,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#262626") : Color.ParseColor("#fff9f9"),
                                    SectionName = activityContext.GetText(Resource.String.Lbl_LiveVideos),
                                    BadgeCount = 0,
                                    StyleRow = styleRowMore,
                                    Badgevisibilty = false,
                                    IconAsImage = Resource.Drawable.ic_more_live,
                                    Icon = IonIconsFonts.IosRadio,
                                    IconColor = Color.ParseColor("#C62828")
                                });
                                break;
                        }
                        ...
                        switch (AppSettings.ShowAdvertise)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    Id = 26,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#282828") : Color.ParseColor("#faf7ff"),
                                    SectionName = activityContext.GetText(Resource.String.Lbl_Advertising),
                                    BadgeCount = 0,
                                    StyleRow = styleRowMore,
                                    Badgevisibilty = false,
                                    IconAsImage = Resource.Drawable.ic_more_ads,
                                    Icon = IonIconsFonts.IosAnalytics,
                                    IconColor = Color.ParseColor("#C2185B")
                                });
                                break;
                        }

                        switch (AppSettings.ShowGoPro)
                        {
                            case true:
                                SectionList.Add(new SectionItem
                                {
                                    Id = 27,
                                    BackIcon = WoWonderTools.IsTabDark() ? Color.ParseColor("#212121") : Color.ParseColor("#fff8f8"),
                                    SectionName = activityContext.GetText(Resource.String.Lbl_Go_Pro),
                                    BadgeCount = 0,
                                    StyleRow = styleRowMore,
                                    Badgevisibilty = false,
                                    IconAsImage = Resource.Drawable.post_icon_flash,
                            ...
                            if (item.Id == 1)
                            {
                                ...
                                if (myProfile != null)
                                {
                                    ...
                                    if (AppSettings.ShowUserPoint)
                                        text += Methods.FunString.FormatPriceValue(Convert.ToInt32(myProfile.Points)) + " " + ActivityContext.GetText(Resource.String.Btn_Points) + "\n";

                                    text += Methods.FunString.FormatPriceValue(Convert.ToInt32(myProfile.Details.DetailsClass.PostCount)) + " " + ActivityContext.GetText(Resource.String.Lbl_Posts);

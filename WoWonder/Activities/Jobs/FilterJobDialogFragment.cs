        ...
        private void ClearbuttonOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (BtnPrev != null)
                {
                    ...
                    BtnPrev.SetTextColor(WoWonderTools.IsTabDark() ? Color.ParseColor("#ffffff") : Color.ParseColor("#B0B6C3"));
                }
                 
                BtnJobType1.SetBackgroundResource(Resource.Drawable.round_button_gray);
                BtnJobType1.SetTextColor(WoWonderTools.IsTabDark() ? Color.ParseColor("#ffffff") : Color.ParseColor("#B0B6C3"));

                BtnJobType2.SetBackgroundResource(Resource.Drawable.round_button_gray);
                BtnJobType2.SetTextColor(WoWonderTools.IsTabDark() ? Color.ParseColor("#ffffff") : Color.ParseColor("#B0B6C3"));

                BtnJobType3.SetBackgroundResource(Resource.Drawable.round_button_gray);
                BtnJobType3.SetTextColor(WoWonderTools.IsTabDark() ? Color.ParseColor("#ffffff") : Color.ParseColor("#B0B6C3"));

                BtnJobType5.SetBackgroundResource(Resource.Drawable.round_button_gray);
                BtnJobType5.SetTextColor(WoWonderTools.IsTabDark() ? Color.ParseColor("#ffffff") : Color.ParseColor("#B0B6C3"));
                 
                BtnJobType4.SetBackgroundResource(Resource.Drawable.round_button_gray);
                BtnJobType4.SetTextColor(WoWonderTools.IsTabDark() ? Color.ParseColor("#ffffff") : Color.ParseColor("#B0B6C3"));
        ...
        private void CreateCategoryButtons()
        {
            try
            {
                ...
                foreach (Classes.Categories category in CategoriesController.ListCategoriesJob)
                {
                    ...
                    button.SetTextColor(WoWonderTools.IsTabDark() ? Color.ParseColor("#ffffff") : Color.ParseColor("#B0B6C3"));
                    button.TextSize = 14;

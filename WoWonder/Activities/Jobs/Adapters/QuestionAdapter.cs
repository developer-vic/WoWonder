    ...
    public class QuestionAdapterViewHolder : RecyclerView.ViewHolder
    {
        public QuestionAdapterViewHolder(View itemView, Action<QuestionAdapterClickEventArgs> clickListener, Action<QuestionAdapterClickEventArgs> longClickListener) : base(itemView)
        {
            try
            {
                ...
                Methods.SetColorEditText(EdtQuestionType, WoWonderTools.IsTabDark() ? Color.White : Color.Black);
                Methods.SetColorEditText(EdtQuestion, WoWonderTools.IsTabDark() ? Color.White : Color.Black);
                Methods.SetColorEditText(EdtQuestionAnswer, WoWonderTools.IsTabDark() ? Color.White : Color.Black);

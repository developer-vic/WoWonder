    ...
    public class ViewReelsVideoFragment : AndroidX.Fragment.App.Fragment, IYouTubePlayerInitListener, IPlayerEventListener, StTools.IXAutoLinkOnClickListener
    {
        ...
        private void InitComponent(View view)
        {
            try
            {
                ...
                FollowButton = view.FindViewById<AppCompatButton>(Resource.Id.cont);
        ...
        private void LikeLayoutOnClick(object sender, EventArgs e)
        {
            try
            {
                if (LikeLayout.Tag?.ToString() == "Liked")
                {
                    ...
                    ImgLike.SetImageResource(Resource.Drawable.ic_point_like);
        ...
        private void FollowButtonOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    WoWonderTools.SetAddFriend(Activity, DataVideos.Publisher, FollowButton, true);
                }
            }
            catch (Exception exception)
            {
        ...
        private void SetPlayer()
        {
            try
            {
                ...
                if (controlView != null)
                {
                    var mVolumeIcon = controlView.FindViewById<ImageView>(Resource.Id.exo_volume_icon);
        ...
        private void LoadData(PostDataObject dataObject)
        {
            try
            {
                ...
                WoWonderTools.SetAddFriendCondition(dataObject.Publisher, dataObject.Publisher.IsFollowing, FollowButton , true);

...
{
    public class InvitedFragment : AndroidX.Fragment.App.Fragment
    {
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            try
            {
                ...
                Task.Factory.StartNew(() => ContextEvent.StartApiService("0", "invited"));
            }
        ...
        private void MAdapterOnItemClick(object sender, EventAdapterClickEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    ...
                    intent.PutExtra("EventType", "invited");

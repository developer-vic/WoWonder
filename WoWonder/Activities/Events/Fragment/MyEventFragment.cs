...
{
    public class MyEventFragment : AndroidX.Fragment.App.Fragment
    {
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            try
            {
                ...
                Task.Factory.StartNew(() => ContextEvent.StartApiService("0", "myEvent"));
            }
        ...
        private void MainScrollEventOnLoadMoreEvent(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ContextEvent.StartApiService(item.Id, "myEvent");
                }
            }
            catch (Exception exception)
            {
        ...
        private void SwipeRefreshLayoutOnRefresh(object sender, EventArgs e)
        {
            try
            {
                ...
                ContextEvent.StartApiService("0", "myEvent");
            }
            catch (Exception exception)
            {
                Methods.DisplayReportResultTrack(exception);

...
{
    public class GoingFragment : AndroidX.Fragment.App.Fragment
    {
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            try
            {
                ...
                Task.Factory.StartNew(() => ContextEvent.StartApiService("0", "going"));
            }
        ...
        private void MainScrollEventOnLoadMoreEvent(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ContextEvent.StartApiService(item.Id, "going");
                }
            }
            catch (Exception exception)
            {
        ...
        private void MAdapterOnItemClick(object sender, EventAdapterClickEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    ...
                    intent.PutExtra("EventType", "going");

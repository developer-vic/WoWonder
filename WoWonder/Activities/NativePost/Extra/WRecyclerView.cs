...
namespace WoWonder.Activities.NativePost.Extra
{
    public class WRecyclerView : RecyclerView
    {
        ...
        private static string PostType { set; get; }
            ...
            public void OnChildViewDetachedFromWindow(View view)
            {
                try
                {
                    ...
                    else if (XRecyclerView.ViewHolderVoicePlayer != null && XRecyclerView.ViewHolderVoicePlayer.Equals(view))
                    {
                        ...
                        var holder = new AdapterHolders.SoundPostViewHolder(XRecyclerView.ViewHolderVoicePlayer, XRecyclerView.NativeFeedAdapter, XRecyclerView.NativeFeedAdapter.PostClickListener);
                        if (holder != null)
                        {
            ...
            try
            {
                ...
                switch (list?.Count)
                {
                    case > 0:
                    {
                        ...
                        {
                            var index = NativeFeedAdapter.ListDiffer.IndexOf(item);
                            ...
                            Post(() =>
                            {
                                ...
                                { 
                                    if (index > -1) 
                                        NativeFeedAdapter.NotifyItemChanged(index, "WithoutBlobAudio");
                                }
                                catch (Exception e)
                                {
                                    Methods.DisplayReportResultTrack(e);

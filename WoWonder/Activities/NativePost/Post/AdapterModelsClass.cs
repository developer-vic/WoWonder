...
namespace WoWonder.Activities.NativePost.Post
{
    ...
    {
        Global, Event, Group, Page, Popular, User, Saved, HashTag, SearchForPosts, Memories, Share, Boosted, Video, Live, Advertise
    }
    ...
    public enum PostModelType
    {
        ...
        InfoUserBox = 63 , InfoPageBox = 64 , InfoGroupBox = 65, TikTokPost = 66 , ProfileDetailsSection = 67, MyProfileInfoHeaderSection = 68, UserProfileInfoHeaderSection = 69,SuggestedPagesBox = 70, TwitterPost = 71
    }

...
namespace WoWonder.Library.Anjo
{
    public static class XReactions
    {
        ...
        private static readonly Reaction DefaultReact = new Reaction(ReactConstants.Like, ReactConstants.Default, WoWonderTools.IsTabDark() ? "#ffffff" : "#888888", Resource.Drawable.icon_post_like_vector);  //ic_action_like
